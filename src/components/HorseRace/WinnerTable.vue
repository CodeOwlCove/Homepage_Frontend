...
<template>
    <div v-if="animalStore.displayPlacementList">
      <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 border border-red-50 bg-black w-1/4 h-1/4">
